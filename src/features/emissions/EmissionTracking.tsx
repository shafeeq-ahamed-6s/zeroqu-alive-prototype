    ...
    return (
        <div className="container mx-auto px-4 py-6 space-y-6">
            <div className="space-y-2 flex flex-col md:flex-row md:items-center md:justify-between">
                <div>
                    <h1 className="text-3xl font-bold text-foreground">Emission Tracking</h1>
                    <p className="text-muted-foreground">
                        Monitor emissions, run simulations, and track compliance across your fleet
                    </p>
                </div>
                ...
                <div className="flex flex-row items-center">
                    <Button
                        onClick={() =>
                            (window.location.href = "/emissions#simulation")
                        }
